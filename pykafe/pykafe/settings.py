...
SECRET_KEY = '+-*&h#+0za=kj6$xej()3&42)8#*m85e2fk7ri@^v&9y!31qky'
...
LANGUAGES = (
    ...
    ('mgm', ugettext_lazy('Mambae')),
    ('tet', ugettext_lazy('Tetum')),
    )
...
HAYSTACK_SIGNAL_PROCESSOR = 'members.signals.RealtimeSignalProcessor'

HAYSTACK_CONNECTIONS = {
    'default' : {
            'ENGINE': 'members.search_backends.CustomWhooshEngine',
